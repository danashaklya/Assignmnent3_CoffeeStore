...
export const CoffeeOrderContextProvider = (props) => {
    ...
    return (<CoffeeOrderContext.Provider
     value={{order: order, addCoffeeToOrder: addCoffeeToOrder, removeCoffeeFromOrder: removeCoffeeFromOrder, coffee: coffee,
    initializeCoffee: initializeCoffee }}
    >
        {props.children}
